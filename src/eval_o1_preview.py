...
{row.get('question', '')}"""
    ...
    def get_inference(self, prompt: str) -> Dict[str, Any]:
        ...
        system_prompt = '''
You are an expert in causal inference. The following question is not a typical commonsense query, but rather a meticulously designed question created by a professor specializing in causal inference, intended to assess the students' mastery of the course content. Only give a "yes" or "no" final answer, after your internal reasoning.
        '''.strip()
...
if __name__ == "__main__":
    ...
    inference_model = "o1-preview-2024-09-12"
    ...
    # Load retry IDs
    retry_ids = load_retry_ids("missing_ids.txt")
